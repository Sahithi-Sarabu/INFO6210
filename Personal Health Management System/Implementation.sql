...
INSERT INTO dbo.Person VALUES('Geetha','Sreepada',ENCRYPTBYKEY(KEY_GUID(N'TestSymmetricKey'),'PassTS1'),'F','geetha.sreepada@gmail.com','02-08-1994',4252410372,'Sammamish'),
						 ...
						 ('Anushka','Sharma',ENCRYPTBYKEY(KEY_GUID(N'TestSymmetricKey'),'PassTS11'),'F','anushka.sharma@gmail.com','02-11-1991',4269410372,'Portland'),
						 ('Sachin','Tendulkar',ENCRYPTBYKEY(KEY_GUID(N'TestSymmetricKey'),'PassTS12'),'F','sachin.tendulkar@gmail.com','02-11-1992',4269410372,'Los Angeles'),
						 ('Lakshmi','Gajala',ENCRYPTBYKEY(KEY_GUID(N'TestSymmetricKey'),'PassTS13'),'F','lakshmi.gajala@gmail.com','02-11-1993',4269410372,'San Jose');
